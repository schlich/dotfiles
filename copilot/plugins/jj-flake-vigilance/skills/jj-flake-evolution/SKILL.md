...
- Test: `nix build -f system/system_test.nix`
- Lint: `nix fmt`
...
7. Choose validation based on the touched surface:
   ...
   - smoke coverage when needed: `nix build -f system/system_test.nix`
