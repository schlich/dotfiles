...
8. Treat local validation as the fast gate and GitHub Actions as the comprehensive gate. Once the in-scope local checks succeed, expect `.github/workflows/nix-ci.yml` to run the broader formatting, Home Manager, and NixOS coverage on the PR.
