...
1. Treat local validation as the fast gate and GitHub Actions as the comprehensive gate. Once the relevant local checks succeed, rely on `.github/workflows/nix-ci.yml` for the broader formatting, Home Manager, and both-host NixOS coverage.
